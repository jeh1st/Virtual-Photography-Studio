...
const ImageEditor: React.FC<ImageEditorProps> = ({ baseImageSrc, onClose, onBlend, isProcessing }) => {
  ...
  const handleDetectPerson = async () => {
      ...
      try {
          ...
          // DYNAMIC RESOLUTION OF EXPORT
          // Handle different CDN bundling strategies (Default vs Named)
          // @ts-ignore
          const removeBackground = imglyLib.default?.removeBackground || imglyLib.removeBackground || imglyLib.default;
